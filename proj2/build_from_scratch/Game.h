...
public:
  ...
  */ 
  ...
  void CalcScore();
  // Name: CheckRecipes()
  // Desc - Checks to see if materials can combine
  // Preconditions - two materials diver has are selected
  // Postconditions - Returns true if materials can be combined
  bool CheckRecipes(bool);
  // Name: GameTitle()
