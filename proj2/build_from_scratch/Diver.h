...
class Diver{
 public:
  ...
  // Name IncrementQuantity2
  // Desc - new and improved IncrementQuantity
  // Preconditions - item and index is known
  // Postconditions - Increases quantity of item
  void IncrementQuantity2(Material, int);
